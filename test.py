...
import tools.invoke_agent as ia
...
if __name__ == "__main__":
    ...
    # question = "幫我生成2025 SAS Viya雲端簽呈。"
    ...
    ia.invoke_agent(
        prompt="幫我生成2025 SAS地端簽呈，這份簽呈屬於軟體續約，軟體類別為SAS",
        agent_alias_id="NDIZ1PJQFD",
        agent_id="ZTMZOI2SYI",
        session_id="test_session",
        region="us-east-1",
        output_markdown_name="agent_output.md",
        output_chunk_name="agent_output_chunk.json",
    )
